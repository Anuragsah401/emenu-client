...
const FoodContainer = ({ title, category }) => {
  ...
  return (
    <div className="container mt-[13em] md:mt-[12em] flex flex-col h-[calc(100vh-15em)]">
      {/* Sticky Title */}
      <div className="text-center z-50 py-2">
        <Title text={title} size="1.3rem" />
      </div>

      {/* Scrollable GRID */}
      <div className="flex-1 overflow-y-auto mt-4 md:pt-5 bg-[#f9f9f9] rounded-lg shadow-lg p-4">
        {loading ? (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 md:gap-12 lg:gap-6 xl:gap-8 ">
